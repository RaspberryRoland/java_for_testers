...
public record AddressBookData(
    ...
    public AddressBookData withId(String id) {
        return new AddressBookData(id, this.firstName, this.middleName, this.lastName, this.nickName,
                this.title, address, this.home, mobile, this.email, this.photo, this.work, this.secondary, this.email2, this.email3);
    }
    ...
    public AddressBookData withUselessFields(String middleName, String nickName,
        ...
        return new AddressBookData(this.id, this.firstName, middleName, this.lastName, nickName,
                title, address, home, mobile, email, this.photo, this.work, this.secondary, this.email2, this.email3);
    }
    ...
    public AddressBookData withFirstNameAndLastNameOnly(String firstName, String lastName) {
        return new AddressBookData(this.id, firstName, this.middleName, lastName, this.nickName,
                this.title, this.address, this.home, this.mobile, this.email, this.photo, this.work, this.secondary, this.email2, this.email3);
    }
    ...
    public AddressBookData withAddress(String address) {
        return new AddressBookData(this.id, this.firstName, this.middleName, this.lastName, this.nickName,
                this.title, address, this.home, this.mobile, this.email, this.photo, this.work, this.secondary, this.email2, this.email3);
    }

    public AddressBookData withPhoto(String photo) {
        return new AddressBookData(this.id, this.firstName, this.middleName, this.lastName, this.nickName,
                this.title, this.address, this.home, this.mobile, this.email, photo, this.work, this.secondary, this.email2, this.email3);
    }

    public AddressBookData withHome(String home) {
        return new AddressBookData(this.id, this.firstName, this.middleName, this.lastName, this.nickName,
                this.title, this.address, home, this.mobile, this.email, this.photo, this.work, this.secondary, this.email2, this.email3);
    }

    public AddressBookData withMobile(String mobile) {
        return new AddressBookData(this.id, this.firstName, this.middleName, this.lastName, this.nickName,
                this.title, this.address, this.home, mobile, this.email, this.photo, this.work, this.secondary, this.email2, this.email3);
    }

    public AddressBookData withWork(String work) {
        return new AddressBookData(this.id, this.firstName, this.middleName, this.lastName, this.nickName,
                this.title, this.address, this.home, this.mobile, this.email, this.photo, work, this.secondary, this.email2, this.email3);
    }

    public AddressBookData withSecondary(String secondary) {
        return new AddressBookData(this.id, this.firstName, this.middleName, this.lastName, this.nickName,
                this.title, this.address, this.home, this.mobile, this.email, this.photo, this.work, secondary, this.email2, this.email3);
    }

    public AddressBookData withEmail(String email) {
        return new AddressBookData(this.id, this.firstName, this.middleName, this.lastName, this.nickName,
                this.title, this.address, this.home, this.mobile, email, this.photo, this.work, this.secondary, this.email2, this.email3);
    }

    public AddressBookData withEmail2(String email2) {
        return new AddressBookData(this.id, this.firstName, this.middleName, this.lastName, this.nickName,
                this.title, this.address, this.home, this.mobile, this.email, this.photo, this.work, this.secondary, email2, this.email3);
    }

    public AddressBookData withEmail3(String email3) {
        return new AddressBookData(this.id, this.firstName, this.middleName, this.lastName, this.nickName,
                this.title, this.address, this.home, this.mobile, this.email, this.photo, this.work, this.secondary, this.email2, email3);
    }
}
